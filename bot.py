...
sessions = {
    ...
    # فصل دوم نمونه
    "beg2_1_1": {"title": "جلسه اول فصل دوم", "file_id": "PLACEHOLDER_FILE_ID_1",
                  "caption": "📚 فصل دوم: پیشرفته\n🎓 جلسه اول: جلسات پیشرفته\n\n✅ کپشن جلسه اول فصل دوم\n@cafetradetvaf"},
    "beg2_1_2": {"title": "جلسه دوم فصل دوم", "file_id": "PLACEHOLDER_FILE_ID_2",
...
menu_structure = {
    ...
    "فصل سوم: پروژه عملی": {}  # هنوز جلسه‌ای ندارد
}
